...
<body>
<header class="site-header"><div class="container header-content"><div class="logo"><a href="${root}index.html"><img src="${root}assets/img/logo-site.png" alt="Mente Crua"></a></div><button class="menu-toggle" type="button" aria-label="Abrir menu" aria-controls="site-menu" aria-expanded="false"><span></span><span></span><span></span></button><nav class="menu" id="site-menu"><a href="${root}index.html">Início</a><a href="${root}index.html#artigos">Artigos</a><a href="${root}index.html#temas">Temas</a><a href="${root}modules/pensadores/">Pensadores</a><a href="${root}sobre.html">Sobre</a><a href="${root}contato.html">Contato</a></nav><div class="site-search" role="search"><input class="siteSearchInput" type="search" placeholder="Buscar..." aria-label="Buscar no Mente Crua"><div class="siteSearchResults home-search-results"></div></div></div></header>
<main>
...
<footer class="footer"><div class="container footer-content"><div><h3>Mente Crua</h3><p>Ideias sem filtro para quem ainda gosta de pensar.</p></div><nav><a href="${root}index.html">Início</a><a href="${root}sobre.html">Sobre</a><a href="${root}contato.html">Contato</a></nav></div></footer>
